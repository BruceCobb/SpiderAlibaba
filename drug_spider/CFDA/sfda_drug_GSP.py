...
class sfda_drug():
    ...
    def __init__(self):
        ...
        self.max_page = 9974  # 药品的总页数
        self.max_item = 149600  # 药品的总个数
        self.table_id = 24  # 批准药包材的table_id
        ...
        # 数据库参数
        self.status_table = "sfda_GSP_id_status"
        self.drug_table = "sfda_GSP"
        # requests_data
        ...
        self.logger = logging.basicConfig(filename='sfda_drug_GSP.log')
    ...
    def update_drug_data(self, drug, drug_id):
        sql_drug = """insert into {} values (0 ,{}, "{}","{}","{}","{}","{}","{}","{}","{}","{}")""".format(
            ...
            drug[u"认证范围"], drug[u"发证时间"], drug[u"有效期截止日"], drug[u"备注"], drug[u"注"]
        )
