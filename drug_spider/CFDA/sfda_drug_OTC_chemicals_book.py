...
class sfda_drug():
    ...
    def __init__(self):
        ...
        self.conn = None
        # url参数和遍历参数
        self.cur_page = 7  # 当前药品页数
        self.cur_item = 1  # 当前药品个数
        self.max_page = 80  # 药品的总页数
        self.max_item = 1194  # 药品的总个数
        self.table_id = 1  # 批准药包材的table_id
        ...
        # 数据库参数
        self.status_table = "sfda_OTC_chemicals_book_id_status"
        self.drug_table = "sfda_OTC_chemicals_book"
        # requests_data
        ...
        self.logger = logging.basicConfig(filename='sfda_OTC_chemicals_book.log')
    ...
    def update_drug_data(self, drug, drug_id):
        sql_drug = """insert into {} values (0 ,{}, "{}","{}","{}")""".format(
            self.drug_table, drug_id, drug[u"说明书标题"], drug[u"注"], drug[u"正文"]
        )
