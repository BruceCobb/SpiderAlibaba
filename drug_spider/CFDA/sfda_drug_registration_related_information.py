...
class sfda_drug():
    ...
    def __init__(self):
        ...
        self.max_page = 129  # 药品的总页数
        self.max_item = 1935  # 药品的总个数
        self.table_id = 65  # 药品注册相关专利信息公开公示
        ...
        # 数据库参数
        self.status_table = "sfda_registration_related_information_id_status"
        self.drug_table = "sfda_registration_related_information"
        self.logger = logging.basicConfig(filename='sfda_registration_related_information.log')
    ...
    def update_drug_data(self, drug, drug_id):
        sql_drug = """insert into {} values (0 ,{}, "{}","{}","{}","{}","{}","{}","{}","{}","{}","{}","{}")""".format(
            self.drug_table, drug_id, drug[u"受理号"], drug[u"药品名称"], drug[u"申请人"], drug[u"专利"],
            drug[u"专利名称"], drug[u"邮编"], drug[u"专利到期日或专利授权/公开日期"], drug[u"外国专利"]
            , drug[u"外国专利人"], drug[u"申请人联系地址"], drug[u"专利人"]
        )
