...
class sfda_drug():
    ...
    def __init__(self):
        ...
        self.max_page = 9641  # 药品的总页数
        self.max_item = 144603  # 药品的总个数
        self.table_id = 5  # 申请人申报受理情况
        ...
        # 数据库参数
        self.status_table = "sfda_declare_accept_id_status"
        self.drug_table = "sfda_declare_accept"
        # requests_data
        ...
        self.logger = logging.basicConfig(filename='sfda_drug_declare_accept.log')
    ...
    def update_drug_data(self, drug, drug_id):
        sql_drug = """insert into {} values (0 ,{}, '{}','{}','{}','{}','{}','{}','{}')""".format(
            self.drug_table, drug_id, drug[u"申请人"], drug[u"申请数据收到日"], drug[u"退件或通知单邮寄日"], drug[u"办理状态"],
            drug[u"退件或通知单邮单号"], drug[u"邮寄资料签收日"], drug[u"注"]
        )
