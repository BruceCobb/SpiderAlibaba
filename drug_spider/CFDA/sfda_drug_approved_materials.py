...
class sfda_drug():
    ...
    def __init__(self):
        ...
        self.max_page = 387  # 药品的总页数
        self.max_item = 5801  # 药品的总个数
        self.table_id = 6  # 批准药包材的table_id
        ...
        # 数据库参数
        self.status_table = "sfda_approved_materials_id_status"
        self.drug_table = "sfda_approved_materials"
        # requests_data
        ...
        self.logger = logging.basicConfig(filename='sfda_drug_approved_materials.log')
    ...
    def update_drug_data(self, drug, drug_id):
        sql_drug = """insert into {} values (0 ,{}, '{}', '{}', '{}', '{}', '{}', '{}', '{}')""".format(
            self.drug_table, drug_id, drug[u"品种名称"], drug[u"注册证号"], drug[u"企业名称"], drug[u"产品来源"],
            drug[u"批准日期"], drug[u"规格"], drug[u"注"]
        )
