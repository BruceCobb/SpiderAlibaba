...
class sfda_drug():
    ...
    def __init__(self):
        ...
        self.conn = None
        # url参数和遍历参数
        self.cur_page = 18  # 当前药品页数
        self.max_page = 26  # 药品的总页数

        self.cur_item = 1  # 当前药品个数
        self.max_item = 386  # 药品的总个数
        self.table_id = 102  # 批准药包材的table_id
        ...
        # 数据库参数
        self.status_table = "sfda_drug_narcotic_psychotropic_id_status"
        self.drug_table = "sfda_drug_narcotic_psychotropic"
        self.logger = logging.basicConfig(filename='sfda_drug_narcotic_psychotropic.log')
        # requests_data
    ...
    def update_drug_data(self, drug, drug_id):
        sql_drug = """insert into {} values (0 ,{}, "{}", "{}", "{}", "{}","{}", "{}", "{}")""".format(
            self.drug_table, drug_id, drug[u"中文名"], drug[u"英文名"], drug[u"CAS号"],
            drug[u"备注"], drug[u"药品类别"], drug[u"目录版本"], drug[u"注"]
        )
